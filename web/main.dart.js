...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main_closure_updateList: function main_closure_updateList(t0, t1, t2, t3, t4) {
      var _ = this;
      _._box_0 = t0;
      _.tasks = t1;
      _.taskList = t2;
    ...
    main__updateList_closure: function main__updateList_closure(t0, t1, t2, t3) {
      var _ = this;
      _.tasks = t0;
      _.i = t1;
      _.checkbox = t2;
    ...
    main__updateList_closure0: function main__updateList_closure0(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _._box_0 = t0;
      _.editTitleInput = t1;
    ...
    main__updateList_closure1: function main__updateList_closure1(t0, t1) {
      this._box_0 = t0;
      this.updateList = t1;
    },
    main__updateList_closure2: function main__updateList_closure2(t0, t1, t2) {
      this._box_0 = t0;
      this.i = t1;
      this.updateList = t2;
    },
    main__updateList_closure3: function main__updateList_closure3(t0, t1, t2, t3) {
      var _ = this;
      _._box_0 = t0;
      _.tasks = t1;
      _.i = t2;
    ...
    main__updateList_closure4: function main__updateList_closure4() {
    },
    main__closure: function main__closure(t0, t1, t2, t3) {
      var _ = this;
      _.taskTitleInput = t0;
      _.taskDescriptionInput = t1;
      _.tasks = t2;
      _.updateList = t3;
    },
  ...
  A.main_closure.prototype = {
    call$1($event) {
      var t2, taskTitleInput, taskDescriptionInput, addButton, taskList, t3, countSpan, emptyState, tasks, t1 = {};
      ...
      t1.editingIndex = -1;
      t1 = new A.main_closure_updateList(t1, tasks, taskList, emptyState, countSpan);
      addButton.toString;
      B.ButtonElement_methods.addEventListener$2(addButton, "click", new A.main__closure(taskTitleInput, taskDescriptionInput, tasks, t1));
      taskTitleInput.toString;
      B.InputElement_methods.addEventListener$2(taskTitleInput, "keypress", new A.main__closure0(addButton));
      t1.call$0();
      A.print("Aplica\xe7\xe3o inicializada com sucesso!");
    },
    $signature: 1
  };
  A.main_closure_updateList.prototype = {
    call$0() {
      var t3, t4, t5, t6, i, task, t7, t8, checkbox, taskContent, editTitleInput, t9, editDescriptionInput, buttonGroup, taskTitle, taskDescription, pendingCount, _this = this,
        _s9_ = "completed",
        _s11_ = "description",
        _s12_ = "button-group",
        _s5_ = "click",
      ...
      if (t1.length === 0) {
        ...
        for (t3 = type$._ElementEventStreamImpl_MouseEvent, t4 = _this._box_0, t5 = t3._eval$1("~(1)?"), t3 = t3._precomputed1, t6 = type$.nullable_dynamic_Function_Event, i = 0; i < t1.length; ++i) {
          task = t1[i];
          t7 = document;
          t8 = t7.createElement("li");
          t8.toString;
          ...
          B.InputElement_methods._addEventListener$3(checkbox, "change", t6._as(new A.main__updateList_closure(t1, i, checkbox, _this)), null);
          taskContent = t7.createElement("div");
          taskContent.className = "task-content";
          if (t4.editingIndex === i) {
            editTitleInput = A.InputElement_InputElement();
            editTitleInput.className = "edit-title-input";
            t9 = task.$index(0, "title");
            B.InputElement_methods.set$value(editTitleInput, A._asStringQ(t9 == null ? "" : t9));
            editDescriptionInput = t7.createElement("textarea");
            editDescriptionInput.className = "edit-description-input";
            t9 = task.$index(0, _s11_);
            B.TextAreaElement_methods.set$value(editDescriptionInput, A._asStringQ(t9 == null ? "" : t9));
            taskContent.appendChild(editTitleInput).toString;
            taskContent.appendChild(editDescriptionInput).toString;
            buttonGroup = t7.createElement("div");
            buttonGroup.className = _s12_;
            t9 = t7.createElement("button");
            t9.toString;
            B.ButtonElement_methods.set$text(t9, "Salvar");
            t9.className = "save-btn";
            A._EventStreamSubscription$(t9, _s5_, t5._as(new A.main__updateList_closure0(t4, editTitleInput, editDescriptionInput, t1, i, _this)), false, t3);
            t7 = t7.createElement("button");
            t7.toString;
            B.ButtonElement_methods.set$text(t7, "Cancelar");
            t7.className = "cancel-btn";
            A._EventStreamSubscription$(t7, _s5_, t5._as(new A.main__updateList_closure1(t4, _this)), false, t3);
            buttonGroup.appendChild(t9).toString;
            buttonGroup.appendChild(t7).toString;
            t8.appendChild(checkbox).toString;
            t8.appendChild(taskContent).toString;
            t8.appendChild(buttonGroup).toString;
            editTitleInput.focus();
          } else {
            taskTitle = t7.createElement("div");
            taskTitle.className = "task-title";
            t9 = task.$index(0, "title");
            B.DivElement_methods.set$text(taskTitle, A._asStringQ(t9 == null ? "" : t9));
            taskContent.appendChild(taskTitle).toString;
            t9 = task.$index(0, _s11_);
            if ((t9 == null ? null : J.get$isNotEmpty$asx(t9)) === true) {
              taskDescription = t7.createElement("div");
              taskDescription.className = "task-description";
              t9 = task.$index(0, _s11_);
              B.DivElement_methods.set$text(taskDescription, A._asStringQ(t9 == null ? "" : t9));
            ...
            t9 = t7.createElement("button");
            t9.toString;
            B.ButtonElement_methods.set$text(t9, "Editar");
            t9.className = "edit-btn";
            A._EventStreamSubscription$(t9, _s5_, t5._as(new A.main__updateList_closure2(t4, i, _this)), false, t3);
            t7 = t7.createElement("button");
            t7.toString;
            B.ButtonElement_methods.set$text(t7, "Remover");
            t7.className = "remove-btn";
            A._EventStreamSubscription$(t7, _s5_, t5._as(new A.main__updateList_closure3(t4, t1, i, _this)), false, t3);
            buttonGroup.appendChild(t9).toString;
            buttonGroup.appendChild(t7).toString;
            t8.appendChild(checkbox).toString;
            t8.appendChild(taskContent).toString;
          ...
          t2.appendChild(t8).toString;
        }
      }
      t2 = A._arrayInstanceType(t1);
      pendingCount = new A.WhereIterable(t1, t2._eval$1("bool(1)")._as(new A.main__updateList_closure4()), t2._eval$1("WhereIterable<1>")).get$length(0);
      t2 = document;
  ...
  A.main__updateList_closure.prototype = {
    call$1($event) {
      ...
      _this.updateList.call$0();
    },
    $signature: 1
  };
  A.main__updateList_closure0.prototype = {
    call$1(_) {
  ...
  A.main__updateList_closure1.prototype = {
    call$1(_) {
      type$.MouseEvent._as(_);
      this._box_0.editingIndex = -1;
      this.updateList.call$0();
    },
    $signature: 2
  };
  A.main__updateList_closure2.prototype = {
    call$1(_) {
      type$.MouseEvent._as(_);
      this._box_0.editingIndex = this.i;
      this.updateList.call$0();
    },
    $signature: 2
  };
  A.main__updateList_closure3.prototype = {
    call$1(_) {
  ...
  A.main__updateList_closure4.prototype = {
    call$1(task) {
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null(Event)", "~(MouseEvent)", "~(~())", "Null(@)", "Null()", "bool(NodeValidator)", "bool(String)", "bool(Element,String,String,_Html5NodeValidator)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(Object,StackTrace)", "~(Object?,Object?)", "bool(Node)", "~(Event)", "String(String)", "~(Node,Node?)", "bool(Map<String,@>)"],
